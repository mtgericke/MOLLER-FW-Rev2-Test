...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of mollerTI_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins mollerTI_0/S_AXI]
	connect_bd_net [get_bd_pins mollerTI_0/s_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mollerTI_0/s_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of mollerTI_0 streaming interfaces..
	connect_bd_net [get_bd_pins mollerTI_0/c2h_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mollerTI_0/c2h_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins mollerTI_0/h2c_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mollerTI_0/h2c_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to mollerTI_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/mollerTI_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mollerTI_0_S_AXI_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/mollerTI_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "mollerTI_v1_0_hw_${i}"
